/*
  ...
  1. Changes
    - Create smtp_settings table to store email server configuration
    - Add necessary columns for host, port, credentials, etc.
    - Set up default values and constraints
    
  2. Security
    - Enable RLS on the table
    - Add policies to ensure only super admins can manage SMTP settings
*/
