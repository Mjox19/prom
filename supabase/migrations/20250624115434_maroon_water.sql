/*
  # User Roles and Row Level Security Implementation

  1. User Role System
    - Add role column to profiles table with constraint
    - Create helper functions for role checking
    - Set up automatic profile creation for new users

  2. Row Level Security Policies
    - Enable RLS on all sensitive tables
    - Create policies for data isolation based on user roles
    - Super admins can access all data, users only their own

  3. Security Functions
    - Functions for safe role management
...
-- Users can update their own profile, super admins can update anything
